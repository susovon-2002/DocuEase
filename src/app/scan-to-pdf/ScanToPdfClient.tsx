...
export function ScanToPdfClient() {
  ...
  const handleGeneratePdf = async () => {
      if (capturedImages.length === 0) {
          toast({ variant: 'destructive', title: 'No Images Captured', description: 'Please capture at least one image.'});
          return;
      }
  ...
  return (
    <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground mt-2">Use your camera to capture documents and convert them to a PDF.</p>
        </div>
