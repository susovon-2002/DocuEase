    ...
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      ...
      <div className="prose dark:prose-invert max-w-none">
        ...
        <p>
          ...
          usage of domain name https://docu-ease.vercel.app/ ('Website'), including the
          related mobile site and mobile application (hereinafter referred to as 'Platform').
        </p>
        <p>
          The Platform is owned by DocuEase, a company with its registered office at Sector v,
          Bidhannagar, Near Technopolis, kolkata 700091 (hereinafter referred to as
        ...
        <p>
          ...
          transact on the Platform, You shall be subject to the policies that are applicable to
          the Platform for such transaction. By mere use of the Platform, You shall be
          contracting with the Platform Owner and these terms and conditions including the
          policies constitute Your binding obligations, with Platform Owner. These Terms of Use
          ...
          Platform Owner and shall be of no force or effect. These Terms of Use can be
          modified at any time without assigning any reason. It is your responsibility to
          periodically review these Terms of Use to stay informed of updates..
        </p>
        <p>
          For the purpose of these Terms of Use, wherever the context so requires ‘you’, 'your'
        ...
        <ul>
          ...
          <li>
            ...
            the exclusive jurisdiction of the courts in Medinipur and West Bengal.
          </li>
          <li>
